...
void Defensive::playerPowerPlantAuctionStrategy(Player* player) {
	//Will be implemented for the last build of this project 
}
void Defensive::playerBuyingRessourcesStrategy(Player* player) {
	//Will be implemented for the last build of this project 
}
void Defensive::playerBuildingStrategy(Player* player) {
	//Will be implemented for the last build of this project 
}
void Defensive::playerBureaucracyStrategy(Player* player) {
	
	bool isGood = false; 

	//Notifies the strategy of the user on the console (in this case: DEFENSIVE) :
	cout << "\n" << player->getName() << " strategy is at DEFENSIVE" << endl;
